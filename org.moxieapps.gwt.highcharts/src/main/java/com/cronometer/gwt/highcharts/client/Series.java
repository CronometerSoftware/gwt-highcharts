...
import com.cronometer.gwt.highcharts.client.plotOptions.PlotOptions;
...
/**
 * Manages a data series (and its options) that can then be added to a {@link com.cronometer.gwt.highcharts.client.Chart}.  As an extension
 * of {@link com.cronometer.gwt.highcharts.client.Configurable} each series instance can also optionally have configuration options set on it.
 * In order to create a new series, utilize the {@link com.cronometer.gwt.highcharts.client.Chart#createSeries()} method, configure it, add data
 * to it, and then add it to the chart via the {@link com.cronometer.gwt.highcharts.client.Chart#addSeries(com.cronometer.gwt.highcharts.client.Series)} method.  Note that a series
...
public class Series extends Configurable<Series> {
     ...
     * {@link com.cronometer.gwt.highcharts.client.Series#setType(com.cronometer.gwt.highcharts.client.Series.Type)} or {@link com.cronometer.gwt.highcharts.client.Chart#setType(com.cronometer.gwt.highcharts.client.Series.Type)}.
     */
    public enum Type {
         ...
         * Only available when you're using the {@link com.cronometer.gwt.highcharts.client.StockChart} widget type.
         *
         * @since 1.1.0
         */
        OHLC("ohlc"),
    ...
    /**
     * Use the {@link com.cronometer.gwt.highcharts.client.Chart#createSeries()} method to create new series instances.
     *
     ...
     * @return  reference to this {@link com.cronometer.gwt.highcharts.client.Series} instance for convenient method chaining.
     */
     ...
     * @return A reference to this {@link com.cronometer.gwt.highcharts.client.Series} instance for convenient method chaining.
     */
     ...
     * </code></pre>
     * Note that if you don't set this explicitly the default series type is {@link com.cronometer.gwt.highcharts.client.Series.Type#LINE}.
     *
     ...
     * options for all series in the chart (of each type) can be set on the {@link com.cronometer.gwt.highcharts.client.Chart} instance,
     * and therefore you only need to use this method if you want to override the plot options for
     * this series only.
     * <p/>
     * Note that the general {@link com.cronometer.gwt.highcharts.client.plotOptions.PlotOptions} type only represents the abstract base class of all the
     * different series types.  To call this method you need to instantiate one of the concrete
     * sub-classes instead (e.g. {@link com.cronometer.gwt.highcharts.client.plotOptions.AreaPlotOptions},
     * {@link com.cronometer.gwt.highcharts.client.plotOptions.BarPlotOptions}, etc.).
     * <p/>
     ...
     * the chart and then re-add it to the chart via the {@link com.cronometer.gwt.highcharts.client.Chart#addSeries(com.cronometer.gwt.highcharts.client.Series)} method.
     *
     ...
     *                  {@link com.cronometer.gwt.highcharts.client.Chart#redraw()} is explicitly called
     ...
     *                  Note, see the {@link #addPoint(Number, boolean, boolean, com.cronometer.gwt.highcharts.client.Animation)} method
     ...
     *                  a value over time.
     * @param animation Defaults to true. When true, the graph will be animated with default animation options.
     *                  Note, see the {@link #addPoint(Number, Number, boolean, boolean, com.cronometer.gwt.highcharts.client.Animation)} method
     *                  for more control over how the animation will run.
     * @return A reference to this {@link com.cronometer.gwt.highcharts.client.Series} instance for convenient method chaining.
     */
     ...
     *                  a value over time.
     * @param animation Defaults to true. When true, the graph will be animated with default animation options.
     *                  Note, see the {@link #addPoint(com.cronometer.gwt.highcharts.client.Point, boolean, boolean, com.cronometer.gwt.highcharts.client.Animation)} method
     *                  for more control over how the animation will run.
     * @return A reference to this {@link com.cronometer.gwt.highcharts.client.Series} instance for convenient method chaining.
     */
     ...
     * {@link #setPoints(com.cronometer.gwt.highcharts.client.Point[])} method instead.
     *
     ...
     * more control than just simply setting the y values of each data point, then use the
     * {@link #setPoints(com.cronometer.gwt.highcharts.client.Point[], boolean)} method instead.
     *
     * @param yValues The array of Y values to set on the data series (replacing any data already in place)
     ...
     *                {@link com.cronometer.gwt.highcharts.client.Chart#redraw()} after.
     * @return A reference to this {@link com.cronometer.gwt.highcharts.client.Series} instance for convenient method chaining.
     */
     ...
     * use the {@link #setPoints(com.cronometer.gwt.highcharts.client.Point[])} method instead.
     *
     ...
     * that have been set in persistent mode via the {@link com.cronometer.gwt.highcharts.client.BaseChart#setPersistent(boolean)} method.
     * If you're using non-persistent charts, you can instead simply use the
     * {@link com.cronometer.gwt.highcharts.client.Point#remove()} method to achieve the same affect.
     *
     ...
     * that have been set in persistent mode via the {@link com.cronometer.gwt.highcharts.client.BaseChart#setPersistent(boolean)} method.
     * If you're using non-persistent charts, you can instead simply use the
     * {@link com.cronometer.gwt.highcharts.client.Point#remove(boolean, boolean)} method to achieve the same affect.
     *
     * @param point     The point instance (obtained dynamically from the chart) to remove from the series.
     * @param redraw    Whether to redraw the chart after the point is removed. When removing more than one
     *                  point, it is highly recommended that the redraw option be set to false, and instead
     *                  {@link com.cronometer.gwt.highcharts.client.Chart#redraw()} is explicitly called after the removing of points is finished.
     * @param animation Defaults to true. When true, the graph will be animated with default animation options.
     *                  Note, see the {@link #removePoint(com.cronometer.gwt.highcharts.client.Point, boolean, com.cronometer.gwt.highcharts.client.Animation)} method
     *                  for more control over how the animation will run.
     * @return A reference to this {@link com.cronometer.gwt.highcharts.client.Series} instance for convenient method chaining.
     * @since 1.3.0
     */
     ...
     * that have been set in persistent mode via the {@link com.cronometer.gwt.highcharts.client.BaseChart#setPersistent(boolean)} method.
     * If you're using non-persistent charts, you can instead simply use the
     * {@link com.cronometer.gwt.highcharts.client.Point#remove(boolean, com.cronometer.gwt.highcharts.client.Animation)} method to achieve the same affect.
     *
     * @param point     The point instance (obtained dynamically from the chart) to remove from the series.
     * @param redraw    Whether to redraw the chart after the point is removed. When removing more than one
     *                  point, it is highly recommended that the redraw option be set to false, and instead
    ...
    /**
     * Hides the series if visible. If the {@link com.cronometer.gwt.highcharts.client.BaseChart#setIgnoreHiddenSeries(boolean)} option is true,
     ...
     * then use the {@link com.cronometer.gwt.highcharts.client.BaseChart#redraw()} method to update the
     ...
     * toggled and when selected, the series is returned in the {@link com.cronometer.gwt.highcharts.client.BaseChart#getSelectedSeries()} method.
     *
