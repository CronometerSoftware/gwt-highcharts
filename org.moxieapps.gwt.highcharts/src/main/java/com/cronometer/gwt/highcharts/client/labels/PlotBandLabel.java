...
/**
 * Represents the configuration options that can be set for the labels of a {@link com.cronometer.gwt.highcharts.client.PlotBand}, and
 * can then be passed to the {@link com.cronometer.gwt.highcharts.client.PlotBand#setLabel(PlotBandLabel)} method.  Example usage:
 * <code><pre>
...
public class PlotBandLabel extends Configurable<PlotBandLabel> {
     ...
     * @return A reference to this {@link com.cronometer.gwt.highcharts.client.labels.PlotBandLabel} instance for convenient method chaining.
     */
