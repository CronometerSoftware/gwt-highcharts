...
import com.cronometer.gwt.highcharts.client.events.*;
import com.cronometer.gwt.highcharts.client.labels.AxisLabelsData;
import com.cronometer.gwt.highcharts.client.labels.DataLabelsData;
import com.cronometer.gwt.highcharts.client.labels.LegendLabelsData;
import com.cronometer.gwt.highcharts.client.labels.StackLabelsData;
import com.cronometer.gwt.highcharts.client.plotOptions.*;
...
public abstract class BaseChart<T> extends Widget {
     ...
     * initial series animation, see {@link com.cronometer.gwt.highcharts.client.plotOptions.PlotOptions#setAnimation(boolean)} method for
     ...
     * the chart by setting it to false here. It can be overridden for each individual API
     * method as a function parameter. The only animation not affected by this option is the
     * initial series animation, see {@link com.cronometer.gwt.highcharts.client.plotOptions.PlotOptions#setAnimation(Animation)} method for
     * control over series animations that are added after the chart has been rendered.
     * <p/>
     ...
     * Note that the colors for each series can be overridden via the {@link com.cronometer.gwt.highcharts.client.plotOptions.PlotOptions#setColor(String)} mechanism.
     * <p/>
     ...
     * {@link com.cronometer.gwt.highcharts.client.plotOptions.Marker#setSymbol(com.cronometer.gwt.highcharts.client.plotOptions.Marker.Symbol)} method
     * (which can be set on the series via its plot options, see
     * {@link Series#setPlotOptions(com.cronometer.gwt.highcharts.client.plotOptions.PlotOptions)}).
     * <p/>
     ...
     * be overridden for each individual series via the {@link Series#setPlotOptions(com.cronometer.gwt.highcharts.client.plotOptions.PlotOptions)} method.
     * <p/>
     * Note that changing the plot options on a chart that has already been rendered will only affect
     * series that are subsequently added to the chart (and will not impact any of the series that are already
     * rendered in the chart.)
     ...
     * {@link #setLinePlotOptions(com.cronometer.gwt.highcharts.client.plotOptions.LinePlotOptions)},
     * {@link #setAreaPlotOptions(com.cronometer.gwt.highcharts.client.plotOptions.AreaPlotOptions)}, etc.)
     * <p/>
     ...
     * Information where the user clicked can then be found through the {@link com.cronometer.gwt.highcharts.client.events.ChartClickEvent} instance
     * that is passed to the handler's {@link com.cronometer.gwt.highcharts.client.events.ChartClickEventHandler#onClick(com.cronometer.gwt.highcharts.client.events.ChartClickEvent)} method.
     *
     ...
     * <br/><br/>
     * Some event methods (such as {@link com.cronometer.gwt.highcharts.client.events.SeriesClickEvent#getSeriesId()})
    ...
    private native JavaScriptObject nativeRenderChart(String chartTypeName,
        ...
        for (var type1 in chartEventHandlerFlags) {
            if (type1.indexOf("gwt") < 0 && chartEventHandlerFlags[type1]) {
                ...
                options.chart.events[type1] = function (e) {
                    return self.@com.cronometer.gwt.highcharts.client.BaseChart::chartEventCallback(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;)(e, arguments.callee.type);
                };
        ...
        for (var type2 in seriesEventHandlerFlags) {
            if (type2.indexOf("gwt") < 0 && seriesEventHandlerFlags[type2]) {
                ...
                options.plotOptions.series.events[type2] = function (e) {
                    return self.@com.cronometer.gwt.highcharts.client.BaseChart::seriesEventCallback(Lcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;)(this, e, arguments.callee.type);
                };
        ...
        for (var type3 in pointEventHandlerFlags) {
            if (type3.indexOf("gwt") < 0 && pointEventHandlerFlags[type3]) {
                ...
                options.plotOptions.series.point.events[type3] = function (e) {
                    return self.@com.cronometer.gwt.highcharts.client.BaseChart::pointEventCallback(Lcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;)(this, e, arguments.callee.type);
                };
        ...
        for (i = 0; i < xAxisEventHandlerFlags.length; i++) {
            ...
            for (var type4 in xAxisEventHandlerFlags[i]) {
                xAxisA.events[type4] = function (e) {
                    return self.@com.cronometer.gwt.highcharts.client.BaseChart::axisEventCallback(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;)(this.options.id, e, arguments.callee.type);
                };
        ...
        if (toolTipFormatterFlag) {
            ...
            options.tooltip.formatter = function () {
                var result = self.@com.cronometer.gwt.highcharts.client.BaseChart::toolTipFormatterCallback(Lcom/google/gwt/core/client/JavaScriptObject;)(this);
                if (result == null) {
                    return false;
                }
                return result;
        ...
        if (legendLabelsFormatterFlag) {
            ...
            options.legend.labelFormatter = function () {
                var result = self.@com.cronometer.gwt.highcharts.client.BaseChart::legendLabelsFormatterCallback(Lcom/google/gwt/core/client/JavaScriptObject;)(this);
                if (result == null) {
                    return false;
                }
                return result;
        ...
        for (i = 0; i < xAxisLabelFormatterFlags.length; i++) {
            ...
            xAxisB.labels.formatter = function () {
                return self.@com.cronometer.gwt.highcharts.client.BaseChart::xAxisLabelFormatterCallback(Lcom/google/gwt/core/client/JavaScriptObject;I)(this, arguments.callee.index);
            };
        ...
        for (i = 0; i < yAxisLabelFormatterFlags.length && i < yAxisStackLabelFormatterFlags.length; i++) {
            ...
            if (yAxisLabelFormatterFlags[i]) {
                ...
                yAxisB.labels.formatter = function () {
                    return self.@com.cronometer.gwt.highcharts.client.BaseChart::yAxisLabelFormatterCallback(Lcom/google/gwt/core/client/JavaScriptObject;I)(this, arguments.callee.index);
                };
            ...
            if (yAxisStackLabelFormatterFlags[i]) {
                ...
                yAxisB.stackLabels.formatter = function () {
                    return self.@com.cronometer.gwt.highcharts.client.BaseChart::yAxisStackLabelFormatterCallback(Lcom/google/gwt/core/client/JavaScriptObject;I)(this, arguments.callee.index);
                };
        ...
        for (var type6 in plotOptionsLabelsFormatterFlags) {
            if (type6.indexOf("gwt") < 0 && plotOptionsLabelsFormatterFlags[type6]) {
                ...
                options.plotOptions[type6].dataLabels.formatter = function () {
                    return self.@com.cronometer.gwt.highcharts.client.BaseChart::plotOptionsLabelsFormatterCallback(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;)(this, arguments.callee.type);
                };
        ...
        for (i = 0; i < seriesLabelsFormatterFlags.length; i++) {
            ...
            series.dataLabels.formatter = function () {
                return self.@com.cronometer.gwt.highcharts.client.BaseChart::seriesLabelsFormatterCallback(Lcom/google/gwt/core/client/JavaScriptObject;I)(this, arguments.callee.index);
            };
