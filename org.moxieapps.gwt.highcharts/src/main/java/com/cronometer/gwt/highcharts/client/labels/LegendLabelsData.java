...
public class LegendLabelsData {
    ...
    public native String getSeriesId() /*-{
        return this.@com.cronometer.gwt.highcharts.client.labels.LegendLabelsData::data.options.id;
    }-*/;
    ...
    public native String getSeriesName() /*-{
        return this.@com.cronometer.gwt.highcharts.client.labels.LegendLabelsData::data.name;
    }-*/;
