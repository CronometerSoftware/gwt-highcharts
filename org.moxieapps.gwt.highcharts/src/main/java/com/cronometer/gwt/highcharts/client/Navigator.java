 ...
 * to zoom in and out on parts of the data as well as panning across the dataset. Applies only to {@link com.cronometer.gwt.highcharts.client.StockChart}.
 *
...
public class Navigator extends Configurable<Navigator> {
    ...
    /**
     * Use the {@link com.cronometer.gwt.highcharts.client.StockChart#getNavigator()} method to get access to the Navigator of the chart.
     *
    ...
    /**
     * Access the navigator series, to allow for customization via the {@link Series#setPlotOptions(com.cronometer.gwt.highcharts.client.plotOptions.PlotOptions)}
     * method.
     * <pre><code>
