...
import com.cronometer.gwt.highcharts.client.DateTimeLabelFormats;
...
public class DataGrouping extends Configurable<DataGrouping> {
    ...
    public static class Unit extends JSONArray {
         ...
         * @see com.cronometer.gwt.highcharts.client.plotOptions.DataGrouping#setUnits(com.cronometer.gwt.highcharts.client.plotOptions.DataGrouping.Unit...)
         */
