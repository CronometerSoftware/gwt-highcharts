...
import com.cronometer.gwt.highcharts.client.labels.PieDataLabels;
...
public class PiePlotOptions extends BaseProportionalPlotOptions<PiePlotOptions> {
     ...
     * that is passed to the handler's {@link com.cronometer.gwt.highcharts.client.events.PointLegendItemClickEventHandler#onClick(com.cronometer.gwt.highcharts.client.events.PointLegendItemClickEvent)} method.
     *
