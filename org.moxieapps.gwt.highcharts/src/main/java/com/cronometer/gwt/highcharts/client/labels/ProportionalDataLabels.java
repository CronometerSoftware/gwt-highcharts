 ...
 * (via the {@link com.cronometer.gwt.highcharts.client.plotOptions.FunnelPlotOptions#setFunnelDataLabels(FunnelDataLabels)}
 * or {@link com.cronometer.gwt.highcharts.client.plotOptions.PiePlotOptions#setPieDataLabels(PieDataLabels)}  methods).
 * <p/>
 * Example usage:
 * <code><pre>
