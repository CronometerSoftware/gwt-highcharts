...
public class SeriesPlotOptions extends PlotOptions<SeriesPlotOptions> {
     ...
     * found via the {@link com.cronometer.gwt.highcharts.client.events.SeriesClickEvent} instance
     * that is passed to the handler's {@link com.cronometer.gwt.highcharts.client.events.SeriesClickEventHandler#onClick(com.cronometer.gwt.highcharts.client.events.SeriesClickEvent)} method.
     *
     * @param seriesClickEventHandler The handler that should be invoked whenever a series click event occurs.
     * @return A reference to this {@link com.cronometer.gwt.highcharts.client.BaseChart} instance for convenient method chaining.
     *
     * @since 1.1.0
     */
     ...
     * {@link com.cronometer.gwt.highcharts.client.events.SeriesCheckboxClickEvent} instance
     * that is passed to the handler's
     * {@link com.cronometer.gwt.highcharts.client.events.SeriesCheckboxClickEventHandler#onClick(com.cronometer.gwt.highcharts.client.events.SeriesCheckboxClickEvent)}
     * method.
     *
