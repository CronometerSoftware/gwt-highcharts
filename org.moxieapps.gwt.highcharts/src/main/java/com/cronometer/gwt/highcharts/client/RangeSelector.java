...
/**
 * The range selector is a tool for selecting ranges to display within a {@link com.cronometer.gwt.highcharts.client.StockChart}. It provides buttons to select
...
public class RangeSelector extends Configurable<RangeSelector> {
     ...
     * like {@link RangeSelector#setInputPositionAlign(com.cronometer.gwt.highcharts.client.RangeSelector.Align)} method.
     */
    public enum Align {
     ...
     * a {@link com.cronometer.gwt.highcharts.client.StockChart}. For example, to create a button to display a 6 month time selection:
     * <pre><code>
     *    new RangeSelector.Button()
