...
import com.cronometer.gwt.highcharts.client.events.AxisSetExtremesEventHandler;
...
public abstract class Axis<T extends Axis> extends Configurable<T> {
     ...
     * found via the {@link com.cronometer.gwt.highcharts.client.events.AxisSetExtremesEvent} instance
     * that is passed to the handler's {@link com.cronometer.gwt.highcharts.client.events.AxisSetExtremesEventHandler#onSetExtremes(com.cronometer.gwt.highcharts.client.events.AxisSetExtremesEvent)} method.
     *
     ...
     *
     * @param title Sets the title of axis, or null to hide the title.
     * @param redraw Whether to redraw the chart now or hold until the next {@link com.cronometer.gwt.highcharts.client.BaseChart#redraw()}
     * @return A reference to this {@link Axis} instance for convenient method chaining.
     * @since 1.2.0
     */
