 ...
 * (via the {@link PlotOptions#setDataLabels(com.cronometer.gwt.highcharts.client.labels.DataLabels)} method).
 * <p/>
 * Note that PlotOptions can then be applied either to the entire chart (via the
 * {@link com.cronometer.gwt.highcharts.client.Chart#setSeriesPlotOptions(com.cronometer.gwt.highcharts.client.plotOptions.SeriesPlotOptions)}
 * method), or to a specific data series (via the {@link com.cronometer.gwt.highcharts.client.Series#setPlotOptions(PlotOptions)}
 * method).
 * <p/>
 * Example usage:
 * <code><pre>
