 ...
 * can then be passed to the {@link com.cronometer.gwt.highcharts.client.YAxis#setLabels(com.cronometer.gwt.highcharts.client.labels.YAxisLabels)}
...
public class YAxisLabels extends Labels<YAxisLabels> {
     ...
     * @return A reference to this {@link com.cronometer.gwt.highcharts.client.labels.YAxisLabels} instance for convenient method chaining.
     */
