...
public abstract class SeriesEvent extends MouseEvent {
    ...
    public native String getSeriesId() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.SeriesEvent::series.options.id;
    }-*/;
    ...
    public native String getSeriesName() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.SeriesEvent::series.name;
    }-*/;
