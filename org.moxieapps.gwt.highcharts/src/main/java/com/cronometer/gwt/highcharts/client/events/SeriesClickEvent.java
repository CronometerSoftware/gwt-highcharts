 ...
 * register it via the {@link com.cronometer.gwt.highcharts.client.plotOptions.SeriesPlotOptions#setSeriesClickEventHandler(SeriesClickEventHandler)}
...
public class SeriesClickEvent extends SeriesEvent {
    ...
    public native String getNearestPointName() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.point.name;
    }-*/;
    ...
    public native double getNearestXAsDouble() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.point.x;
    }-*/;
    ...
    public native double getNearestYAsDouble() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.point.y;
    }-*/;
    ...
    private native JavaScriptObject nativeGetPoint()  /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.point;
    }-*/;
