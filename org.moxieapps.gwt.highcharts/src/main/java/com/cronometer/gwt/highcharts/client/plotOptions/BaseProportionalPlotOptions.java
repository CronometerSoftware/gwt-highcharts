...
import com.cronometer.gwt.highcharts.client.events.PointLegendItemClickEventHandler;
...
public abstract class BaseProportionalPlotOptions<T extends BaseProportionalPlotOptions> extends PlotOptions<T> {
     ...
     * </code></pre>
     * Equivalent to {@link com.cronometer.gwt.highcharts.client.BaseChart#setIgnoreHiddenSeries(boolean)}, this option tells whether the series shall be redrawn as if the hidden point were null.
     * <p/>
     ...
     * found via the {@link com.cronometer.gwt.highcharts.client.events.PointLegendItemClickEventHandler} instance
     * that is passed to the handler's {@link PointLegendItemClickEventHandler#onClick(com.cronometer.gwt.highcharts.client.events.PointLegendItemClickEvent)} method.
     *
