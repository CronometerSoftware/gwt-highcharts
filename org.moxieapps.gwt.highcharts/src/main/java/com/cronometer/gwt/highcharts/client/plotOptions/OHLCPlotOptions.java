 ...
 * on the chart via the {@link com.cronometer.gwt.highcharts.client.StockChart#setOHLCPlotOptions(com.cronometer.gwt.highcharts.client.plotOptions.OHLCPlotOptions)} )} method or directly on a
 ...
 * <p/>
 * Note that OHLC series types are only available when using the {@link com.cronometer.gwt.highcharts.client.StockChart} widget.
 * <p/>
 ...
 * series in the chart (not just those of an OHLC type), then you can use the {@link com.cronometer.gwt.highcharts.client.plotOptions.SeriesPlotOptions}
