...
import com.cronometer.gwt.highcharts.client.Configurable;
import com.cronometer.gwt.highcharts.client.Style;

/**
 * Represents the common base class for all label configuration option types, which allows
 * for general options to be set via the inherited {@link com.cronometer.gwt.highcharts.client.Configurable#setOption(String, Object)}
 * method.  But also exposes type specific methods that the caller is encouraged to use instead,
 * such as {@link #setAlign(com.cronometer.gwt.highcharts.client.labels.Labels.Align)}, {@link #setColor(String)}, etc.
 * <p/>
...
public abstract class Labels<T extends Labels> extends Configurable<T> {
     ...
     * like {@link com.cronometer.gwt.highcharts.client.labels.Labels#setAlign(com.cronometer.gwt.highcharts.client.labels.Labels.Align)} method.
     */
    public enum Align {
     ...
     * @return A reference to this {@link com.cronometer.gwt.highcharts.client.labels.Labels} instance for convenient method chaining.
     */
