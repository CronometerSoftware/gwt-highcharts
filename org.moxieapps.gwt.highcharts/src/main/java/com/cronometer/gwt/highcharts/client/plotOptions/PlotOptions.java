...
import com.cronometer.gwt.highcharts.client.*;
import com.cronometer.gwt.highcharts.client.labels.BaseDataLabels;
import com.cronometer.gwt.highcharts.client.labels.DataLabels;
...
public abstract class PlotOptions<T extends PlotOptions> extends Configurable<T> {
     ...
     * {@link #setCursor(com.cronometer.gwt.highcharts.client.plotOptions.PlotOptions.Cursor)} method.
     */
    public enum Cursor {
     ...
     * control over the way the series display animations will occurs utils the {@link #setAnimation(com.cronometer.gwt.highcharts.client.Animation)}
     * method instead.
     *
     ...
     * {@link com.cronometer.gwt.highcharts.client.Chart#setColors(String...)} method.
     *
     ...
     * none were set.  Note that this method returns an {@link com.cronometer.gwt.highcharts.client.labels.BaseDataLabels} and not simply
     * a {@link DataLabels} in order to handle alternative labels types such as
     * {@link com.cronometer.gwt.highcharts.client.labels.ProportionalDataLabels}.
     *
