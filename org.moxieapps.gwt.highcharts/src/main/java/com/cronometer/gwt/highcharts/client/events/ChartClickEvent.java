 ...
 * register it via the {@link com.cronometer.gwt.highcharts.client.BaseChart#setClickEventHandler(ChartClickEventHandler)}
...
public class ChartClickEvent extends MouseEvent {
    ...
    public native double getXAxisValue(int axisIndex) /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.xAxis[axisIndex].value;
    }-*/;
    ...
    public native double getYAxisValue(int axisIndex) /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.yAxis[axisIndex].value;
    }-*/;
