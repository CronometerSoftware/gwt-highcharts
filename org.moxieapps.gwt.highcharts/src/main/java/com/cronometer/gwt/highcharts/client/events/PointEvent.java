...
public abstract class PointEvent extends MouseEvent {
    ...
    public native String getSeriesId() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.PointEvent::point.series.options.id;
    }-*/;
    ...
    public native String getSeriesName() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.PointEvent::point.series.name;
    }-*/;
    ...
    public native String getPointName() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.PointEvent::point.name;
    }-*/;
    ...
    public native double getXAsDouble() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.PointEvent::point.x;
    }-*/;
    ...
    public native double getYAsDouble() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.PointEvent::point.y;
    }-*/;
