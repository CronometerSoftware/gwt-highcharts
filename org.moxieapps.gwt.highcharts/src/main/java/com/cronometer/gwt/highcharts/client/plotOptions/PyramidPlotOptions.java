...
import com.cronometer.gwt.highcharts.client.labels.PyramidDataLabels;

/**
 *Represents the general plot options available for all pyramid type series, which can be set either generically
 * on the chart via the {@link com.cronometer.gwt.highcharts.client.Chart#setPyramidPlotOptions(PyramidPlotOptions)} )} method or directly on a
