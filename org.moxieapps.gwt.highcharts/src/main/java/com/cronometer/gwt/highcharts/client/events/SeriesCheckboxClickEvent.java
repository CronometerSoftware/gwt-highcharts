 ...
 * register it via the
 * {@link com.cronometer.gwt.highcharts.client.plotOptions.SeriesPlotOptions#setSeriesCheckboxClickEventHandler(SeriesCheckboxClickEventHandler)}
...
public class SeriesCheckboxClickEvent extends SeriesEvent {
    ...
    public native boolean isChecked() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.checked;
    }-*/;
