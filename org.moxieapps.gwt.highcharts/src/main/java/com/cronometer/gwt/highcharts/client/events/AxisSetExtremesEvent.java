...
import com.cronometer.gwt.highcharts.client.Axis;
...
public class AxisSetExtremesEvent extends AxisEvent {
     ...
     * events directly, but instead should register a {@link com.cronometer.gwt.highcharts.client.events.AxisSetExtremesEventHandler}.
     *
    ...
    private native double getMinAsPrimitive() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.AxisEvent::event.min;
    }-*/;
    ...
    private native double getMaxAsPrimitive() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.AxisEvent::event.max;
    }-*/;
}
