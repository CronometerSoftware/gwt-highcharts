...
public abstract class MouseEvent {
    ...
    public native int getClientX() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.clientX || 0;
    }-*/;
    ...
    public native int getClientY() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.clientY || 0;
    }-*/;
    ...
    public native int getNativeButton() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.button || 0;
    }-*/;
    ...
    public native int getScreenX() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.screenX || 0;
    }-*/;
    ...
    public native int getScreenY() /*-{
        return this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.screenY || 0;
    }-*/;
    ...
    public native boolean isAltKeyDown() /*-{
        return !!this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.altKey;
    }-*/;
    ...
    public native boolean isControlKeyDown() /*-{
        return !!this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.ctrlKey;
    }-*/;
    ...
    public native boolean isMetaKeyDown() /*-{
        return !!this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.metaKey;
    }-*/;
    ...
    public native boolean isShiftKeyDown() /*-{
        return !!this.@com.cronometer.gwt.highcharts.client.events.MouseEvent::event.shiftKey;
    }-*/;
