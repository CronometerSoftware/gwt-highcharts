 ...
 * on the chart via the {@link com.cronometer.gwt.highcharts.client.StockChart#setCandlestickPlotOptions(com.cronometer.gwt.highcharts.client.plotOptions.CandlestickPlotOptions)} )} method or directly on a
 * series via the {@link com.cronometer.gwt.highcharts.client.Series#setPlotOptions(com.cronometer.gwt.highcharts.client.plotOptions.PlotOptions)} method.
 * <p/>
 * Note that Candlestick series types are only available when using the {@link com.cronometer.gwt.highcharts.client.StockChart} widget.
 * <p/>
 ...
 * series in the chart (not just those of an Candlestick type), then you can use the {@link com.cronometer.gwt.highcharts.client.plotOptions.SeriesPlotOptions}
