...
import com.cronometer.gwt.highcharts.client.plotOptions.CandlestickPlotOptions;
import com.cronometer.gwt.highcharts.client.plotOptions.OHLCPlotOptions;
...
public class StockChart extends BaseChart<StockChart> {
     ...
     * setting properties of the chart (e.g. {@link #setType(com.cronometer.gwt.highcharts.client.Series.Type)},
